  ...
  class Options
    def self.parse
      ...
      opt_parser = OptionParser.new do |opts|
        ...
        opts.on('--merge-master branch1,branch2', 'Comma-delimited list of branches to merge to master. Master gets pushed to origin. Do "--merge-master all" to merge all ready to ship branches') { |v| options[:master_branches] = v.split(',') }
