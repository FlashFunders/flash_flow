...
module FlashFlow
  class TestDeploy < Minitest::Test
    ...
    def test_print_errors_when_current_branch_cant_merge
      @deploy.instance_variable_set('@merge_errors'.to_sym, ['pushing_branch'])
    ...
    def test_print_errors_when_another_branch_cant_merge
      ...
      other_branch_error = "WARNING: Unable to merge branch pushing_branch to #{Config.configuration.merge_branch} due to conflicts."
